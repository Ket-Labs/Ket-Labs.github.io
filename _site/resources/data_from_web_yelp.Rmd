...
<link rel="shortcut icon" type="image/png" href="/images/favicon.png">
  ...
  <meta name="description" content="Bridging the gap between traditional and data science.
">
    ...
    <div class="footer-col-wrapper">
      <div class="footer-col  footer-col-1">
        <ul class="contact-list">
          <li><strong>Ket Labs, LLC</strong></li>
      ...
      <div class="footer-col  footer-col-3">
         <p class="text">
Bridging the gap between traditional and data science.
